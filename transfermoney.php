...
.main_div
{
    width:100%;
    height:100vh;
    background-image:linear-gradient(rgba(0,0,0,1),rgba(0,1,0,0.6)),url(images/money.jpg);
...
?> 
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:75px;height:370px;">
                   <div class="card-body">
                   <img src="images/arrow.png" style="width:250px;height:220px;margin-top:40px;">
